...
#    pictorial = np.zeros((constants02.height, constants02.width, 1+4), dtype=np.float32)
...
#    x_agent, y_agent = obs[constants02.n_px], obs[constants02.n_px+1]
#    if x_agent >= constants02.width or y_agent >= constants02.height:
#        pass
#    else:
#        pictorial[y_agent, x_agent, 1] = obs[constants02.n_px+2]
#    # position of bots: we put -1 on the coord of the bots
#    for i in range(1, 3+1):
#        if i in eliminated:
#            continue
#        y = obs[constants02.n_px+(2*i+2)]
#        x = obs[constants02.n_px+(2*i+1)]
#        if x >= constants02.width or y >= constants02.height:
#            eliminated.append(i)
#            continue
#        pictorial[y, x, i+1] = -1
#    return pictorial
