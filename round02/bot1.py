...
class Bot1:
    ...
    ACTION_FREE = 4
    ACTION_CRAFT = 5
    non_RL_policies = [non_RL_agent.greedy_policy, non_RL_agent02.greedy_policy, non_RL_agent03.greedy_policy, non_RL_agent06.greedy_policy]

    def __init__(self, id):
        self.state = State()
        self.info = PlayerInfo(id)
        #self.policy = np.random.choice(Bot1.non_RL_policies)
