...
for episode_i in range(0, N_EPISODE):
    try:
        ...
        print("(Episode {: 5d})   cumulated_reward: {:7.1f}   Steps: {: 4d}   eps: {:5.2f}  ({})".format(episode_i+1, total_reward, step + 1, DQNAgent.epsilon, game_over_reason[minerEnv.state.status]))
