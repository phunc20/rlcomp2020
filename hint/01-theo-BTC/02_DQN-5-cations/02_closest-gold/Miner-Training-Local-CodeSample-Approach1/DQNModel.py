...
class DQN: 
    ...
    def __init__(
            ...
            epsilon_decay = 0.9998,#The decay epislon for each update_epsilon time
    ...
    def create_model(self):
      ...
      #with open("TrainedModels/DQNmodel_20200818-1501_ep10000.json", 'r') as f:
      #  j = f.read()
      #model = keras.models.model_from_json(j)    
      #model.load_weights("TrainedModels/DQNmodel_20200818-1501_ep10000.h5")
